...
const code = await rikz.requestPairingCode(phoneNumber.trim(), "MIKEYYV6");
...
if (connection === "open") {
          const ميميك = [   "120363400942992522@newsletter","120363417672193916@newsletter", 
"120363402057772871@newsletter", 
"120363422231886668@newsletter", 
"120363402396161679@newsletter", 
"120363418718340879@newsletter", 
"120363420869347625@newsletter", 
"120363402023756262@newsletter", 
"120363419466286232@newsletter",];
...
//=============================//
console.log(chalk.green.bold(`MANTAP BUYER RAKA `));
console.clear();
StartZenn()
//======================